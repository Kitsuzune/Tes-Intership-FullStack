...
<div class="wrapper">
  ...
  <!-- Navbar -->
  <nav class="main-header navbar navbar-expand navbar-white navbar-red">
    <!-- Left navbar links -->
    <ul class="navbar-nav">
      <li class="nav-item">
                            ...
                            <table class="table table-hover text-nowrap">
                              ...
                              <tbody>
                                ...
                                <tr>
                                  ...
                                  <td>{{ $d->description }}</td>
                                  <td> 
                                      <a href="{{ $d->id }}/edit" class="btn btn-warning"><i class="fas fa-pen"></i> Edit</a>
                                      <form action="{{ $d->id }}" method="POST" class="d-inline">
                                        @method('delete')
                                        @csrf
